package com.feicui.newss.view.slidingmenu;
...
import com.feicui.newss.view.slidingmenu.SlidingMenu.OnClosedListener;
import com.feicui.newss.view.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	private boolean mIsBeingDragged;//Drag ��    /fling ��
	...
	public interface OnPageChangeListener {
		...
		/**
		 * This method will be invoked�����ã� when the current page is scrolled, either as part
		 * of a programmatically initiated smooth���⻬ƽ�ȣ� scroll or a user initiated touch scroll.
		 *
		 * @param position Position index of the first page currently being displayed����ʾ��.
